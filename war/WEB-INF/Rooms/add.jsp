...
<body>
	...
	<div class="div2" align="center">
		<form name="miFormulario" class="form" method="post" action="/room/add" >
		
		<label class="form-label">Room Floor:</label><br>
		<input type="text" name="floor" placeholder="Floor"  class="form-input"  pattern="[1-9]" required/><br><br>
		
		<label class="form-label">Room Number:</label><br>
		<input type="text" name="number" placeholder="Number" class="form-input" pattern="[1-9]"   required/><br><br>
		...
		<select name="kind">
  		...
  		<input type="submit" class="btn-submit" value="Create room">
	</form>
	</div>
</body>
</html>