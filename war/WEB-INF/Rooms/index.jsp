...
<body>
	...
	<div class="div2" align="center">
		...
		<label for="nombre" class="form-label">Room Floor:</label>
		<input type="text" class="form-input" value="<%=r.getPiso()%>" readonly="readonly">
		
		<label for="location" class="form-label">Room Number</label>
		<input type="text"  class="form-input" value="<%=r.getNumero()%>" readonly="readonly">
		
		<label for="hour" class="form-label">Room State</label>
		<input type="text"  class="form-input" value="<%=estados[r.getEstado()]%>" readonly="readonly">
		
		<label for="capacity" class="form-label">Room Kind</label>
		<input type="text"  class="form-input" value="<%=tipos[r.getTipo()]%>" readonly="readonly">
		
		<label for="hour" class="form-label">Room IdGuest</label>
		<input type="text" class="form-input" value="<%=r.getIdGuest()%>" readonly="readonly">
	</div>
</body>
</html>