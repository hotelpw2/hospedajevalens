...
<body>
	...
	<%
			List<Guest> events= (List<Guest>) request.getAttribute("guests");
		%>
<div class="div2" align="center">
	<table class="table1">
		...
		<tr>
			...
			<td> <%=e.getCartera()%></td>
			<td> 
				<a href="/guest/view?id=<%=e.getId()%>">view</a>
			 	<a href="/guest/update?id=<%=e.getId()%>">edit</a>
			 	<a href="/guest/delete?id=<%=e.getId()%>">delete</a>
			</td>
		</tr>
		<%}%>
	</table>
