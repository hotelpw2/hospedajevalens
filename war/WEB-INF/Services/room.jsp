	...
	function validar() {
		if (/^[A-Za-z][A-Za-z]*/.test(document.miFormulario.name.value) == false) {
			...
			return false;
				...
				.test(document.miFormulario.location.value) == false) {
...
<body>
		...
		<ul class="nav">
			...
			<li><a href="">Resources</a>
				<ul>
					...
					<li><a href="/resources/add?action=resourcesCreate">Add
							Resource</a></li>
				</ul></li>
			<li><a href="">Access</a>
				<ul>
	...
	<div class="div2" align="center">
		<form name="miFormulario" class="form" method="post"
			action="/services/room" onsubmit="return validar();">
			<input type="hidden" name="action" value="guestCreateDo" />

			<p>Name:</p>
			<input type="text" name="name" placeholder="Ejemplo: Diego Rivera">
			<p>Phone:</p>
			<input type="text" name="phone" placeholder="Ejemplo: 987654321">
			<p>Age:</p>
			<input type="text" name="age" placeholder="Ejemplo: 20">
			...
			<p>DNI:</p>
			<input type="text" name="dni" placeholder="Ejemplo: 72277675">
			<br> <br> <input type="hidden" id="id" name="tipo"
				class="form-input" value="<%=request.getAttribute("tipo")%>">
			<br></br> <input type="submit" value="Reservar">
