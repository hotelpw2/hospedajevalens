...
public class GuestControllerUpdate extends HttpServlet{
								...
								if(accesoRolePersonaEncontrada.equals(s1)) {
									...
									for (int i = 0; i < guests.size(); i++) {
										...
										if (iddd.equals(name)) {
											...
											req.setAttribute("guest", elegido);
											
										}
										
									}	
									RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Guests/update.jsp");
									dispatcher.forward(req, res);
									}
